...
<div class="crumb-wrap">
    <div class="crumb-list">
        ...
        <span class="crumb-step">&gt;</span>
        <span class="crumb-name">添加</span>
    </div>
</div>
<div class="result-wrap">
    <div class="result-content">
        <form action="{$smarty.const.__ACTION__}?back={I('get.back')}" method="post" enctype="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?="\r"?>
                            <input type="checkbox" name="<?=$v['field']?>" value="<?=$ma[1]?>" {setCheckValue('<?=$ma[1]?>', '<?=$v['field']?>')}><?=$ma[1]?>
                            <?php else:?>
                            <?="\r"?>
                            <select name="<?=$v['field']?>">
                            ...
                            <?="\r"?>
                            <textarea id="<?=$v['field']?>" name="<?=$v['field']?>">{setValue('<?=$v['field']?>')}</textarea>
                            ...
                            <?php else:?>
                            <?="\r"?>
                            <input type="text" name="<?=$v['field']?>" id="<?=$v['field']?>" class="common-text" value="{setValue('<?=$v['field']?>')}">
                            <?php endif;?>
                            <?="\r"?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{$smarty.const.COMMON}/captcha.php" onclick="this.src='{$smarty.const.__CONTROLLER__}/verify/'+Math.random();">
                        </td>
                    </tr>
                    <?php endif;?>
                    <?="\r"?>
